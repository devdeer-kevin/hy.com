...
export default function Home() {
    return (
        <main className="flex justify-center min-h-screen w-full flex-col items-center">
                ...
                <div className="z-10 grid w-full max-w-5xl grid-flow-row items-center justify-center gap-8 font-mono">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            leadership, empathy, and problem-solving. Whether {"it's"} through leveraging my expertise in technology to support non-profit organizations or
                            mentoring the next generation of digital professionals, my voluntary work remains a vital aspect of my personal and professional identity, driving me to
                            foster a culture of innovation, inclusiveness, and social responsibility.
                        </p>
                    </div>
                </div>
            </div>
