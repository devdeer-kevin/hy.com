...
export default function BlogPostWrapper({
    ...
    return (
        <div className="flex flex-col max-w-[1150px] bg-gray-950 bg-opacity-30 backdrop-blur-lg lg:pt-16 lg:pb:16 pt-16 pb-12 px-8 sm:rounded-2xl sm:border-2 sm:border-t-gray-200/30 sm:border-l-gray-200/30 sm:border-r-gray-300/20 sm:border-b-gray-300/20 shadow-2xl">
